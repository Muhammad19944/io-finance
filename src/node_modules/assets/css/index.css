...
.app-card__body {
	background: #fff;
	box-shadow: 0 0px 2px 0px #0000000a;
	border-radius: 4px;
	flex: 1;
    overflow: hidden;
    display: flex;
...
.card-sub-title .ant-tabs, .card-sub-title .ant-tabs-content {
	height: 100%;
}
...
.app-chip {
    ...
    background: rgba(var(--light-darken-3));
    border-radius: 120px;
}
...
.app-date-range .ant-picker-input > input {
	font-family: var(--font-medium);
    color: rgba(var(--dark));
}
